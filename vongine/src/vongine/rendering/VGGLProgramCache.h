...
public:
	...
	GLProgram* AddProgram(const char* vertexFilename, const char* fragmentFilename, const GLProgramName programName);

	/// Return program matching programName or nullptr if not found
	GLProgram* GetProgram(const GLProgramName programName) const;
